...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const js_code = {
        ...
        'org.w3c.dom.item_$external_fun_5' : (_this, p0, isDefault0) => _this.item(isDefault0 ? undefined : p0, ),
    ...
    const wasmFilePath = './OnlineInternautPMeGithubIo-composeApp.wasm';
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./OnlineInternautPMeGithubIo-composeApp.wasm',import.meta.url).href), importObject, { builtins: [''] })).instance;
      }
    } catch (e) {
